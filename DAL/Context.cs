...
namespace LoggingService.DAL
{
    public partial class MeetballDB : IQuerySurface
    {
        ...
        public Query<TextLog> TextLogs { get; set; }
        public Query<PushLog> PushLogs { get; set; }
        public Query<EmailBody> EmailBodies { get; set; }
        public Query<TextBody> TextBodies { get; set; }
        public Query<PushBody> PushBodies { get; set; }
        public Query<MethodLog> MethodLogs { get; set; }
        public Query<MethodLogException> MethodLogExceptions { get; set; }
        public Query<MethodLogError> MethodLogErrors { get; set; }
